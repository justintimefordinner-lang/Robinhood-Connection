...
//
// am_report.py lives in the sibling `databridge` project (its own repo,
...
// databridge/, or APP_DATA_DIR won't be found and the script will exit.
// This runs as a one-off alongside databridge.service's own 30-min
