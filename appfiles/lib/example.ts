  ...
  data: {
    [ACC]: {
      ...
      options: [
        ...
        { id: "ex-o5", kind: "covered-call", symbol: "AAPL", optionType: "call", side: "short", qty: 2, strike: 230, expiration: "2026-08-21", entryPerShare: 4.2, mark: 3.1, delta: 0.34, theta: 0.05, iv: 0.28, breakeven: 234.2, chanceOfProfitShort: 0.66, openedAt: "2026-06-05" },
