  ...
  data: {
    [ACC]: {
      ...
      summary: {
        ...
        // Robinhood reports the margin line itself. Nothing is borrowed here: the puts are
        // cash-secured, so the collateral below sits inside the cash figure above.
        marginLimit: 150000,
        marginUsed: 0,
        optionsCollateral: 295200,
      },
