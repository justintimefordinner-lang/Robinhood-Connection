        ...
        <>
          <Card className="divide-y divide-border">
            {shownTickers.map((t) => {
              ...
              return (
                <div key={t.sym}>
                  <button onClick={() => toggleSym(t.sym)} className="block w-full px-4 py-3 text-left active:bg-surface-2">
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex min-w-0 items-center gap-2">
                  ...
                  {isOpen && (
                    <div className="border-t border-border/50 bg-surface-2/30 px-4 py-1.5">
                      {t.trades.map((tr, i) => (
